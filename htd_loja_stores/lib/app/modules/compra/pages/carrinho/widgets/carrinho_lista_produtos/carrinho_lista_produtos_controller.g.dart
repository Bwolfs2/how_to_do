...
mixin _$CarrinhoListaProdutosController
  ...
  final _$valueAtom = Atom(name: '_CarrinhoListaProdutosControllerBase.value');
  ...
  @override
  void increment() {
    final _$actionInfo = _$_CarrinhoListaProdutosControllerBaseActionController
        .startAction(name: '_CarrinhoListaProdutosControllerBase.increment');
    try {
